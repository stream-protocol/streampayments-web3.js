...
function _nonIterableRest() {
    throw new TypeError("Invalid attempt to restructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
}
...
var loadStreamPayOnramp = function loadStreamPayOnramp() {
    ...
    return Promise.all([loadStreamPay.apply(void 0, args), streampayOnrampPromise]).then(function(_ref) {
...
export { getStandaloneOnrampUrl, loadStreamPayOnramp };